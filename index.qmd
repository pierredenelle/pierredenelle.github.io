...
![](pages/images/coauthorship_network.png)

[^1]The links were extracted from my publications, using the scholar R package. The code was inspired by this [page](https://datalab.ucdavis.edu/2019/08/27/creating-co-author-networks-in-r/).
